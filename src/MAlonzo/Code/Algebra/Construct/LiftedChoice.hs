...
du__'9702'__132 v0 v1
  = coe
      du_Lift_30 (coe MAlonzo.Code.Algebra.Structures.d_sel_168 (coe v0))
      (coe v1)
...
du_sel'45''8801'_134 v0 v1 v2 v3
  = coe
      MAlonzo.Code.Algebra.Structures.d_sel_168 v0 (coe v1 v2)
      (coe v1 v3)
...
du_cong_218 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
  = let v11
          = coe
              MAlonzo.Code.Algebra.Structures.d_sel_168 v1 (coe v2 v5)
              (coe v2 v7) in
    let v12
          = coe
              MAlonzo.Code.Algebra.Structures.d_sel_168 v1 (coe v2 v6)
              (coe v2 v8) in
    case coe v11 of
                       ...
                       (coe
                          ...
                          (coe
                             ...
                             (coe
                                ...
                                (MAlonzo.Code.Algebra.Structures.d_isMagma_166 (coe v1))
...
d_isSemigroup_368 ~v0 ~v1 ~v2 ~v3 v4 v5 ~v6 ~v7 ~v8 v9 v10 v11 v12
                  v13
  = du_isSemigroup_368 v4 v5 v9 v10 v11 v12 v13
du_isSemigroup_368 ::
  (AgdaAny -> AgdaAny -> AgdaAny) ->
  MAlonzo.Code.Algebra.Structures.T_IsSelectiveMagma_158 ->
  (AgdaAny -> AgdaAny) ->
  ...
  (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny) ->
  MAlonzo.Code.Algebra.Structures.T_IsSemigroup_194
du_isSemigroup_368 v0 v1 v2 v3 v4 v5 v6
  = coe
...
d_isBand_376 ~v0 ~v1 ~v2 ~v3 v4 v5 ~v6 ~v7 ~v8 v9 v10 v11 v12 v13
  = du_isBand_376 v4 v5 v9 v10 v11 v12 v13
du_isBand_376 ::
  (AgdaAny -> AgdaAny -> AgdaAny) ->
  MAlonzo.Code.Algebra.Structures.T_IsSelectiveMagma_158 ->
  (AgdaAny -> AgdaAny) ->
  ...
  (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny) ->
  MAlonzo.Code.Algebra.Structures.T_IsBand_230
du_isBand_376 v0 v1 v2 v3 v4 v5 v6
  = coe
      MAlonzo.Code.Algebra.Structures.C_IsBand'46'constructor_4163
      (coe
         du_isSemigroup_368 (coe v0) (coe v1) (coe v2) (coe v3) (coe v4)
         (coe v5) (coe v6))
      (coe
...
d_isSemilattice_380 ~v0 ~v1 ~v2 ~v3 v4 v5 ~v6 ~v7 ~v8 v9 v10 v11
                    v12 v13 v14
  = du_isSemilattice_380 v4 v5 v9 v10 v11 v12 v13 v14
du_isSemilattice_380 ::
  ...
  (AgdaAny -> AgdaAny -> AgdaAny) ->
  MAlonzo.Code.Algebra.Structures.T_IsSemilattice_312
du_isSemilattice_380 v0 v1 v2 v3 v4 v5 v6 v7
  = coe
      MAlonzo.Code.Algebra.Structures.C_IsSemilattice'46'constructor_5951
      (coe
         du_isBand_376 (coe v0) (coe v1) (coe v2) (coe v3) (coe v4) (coe v5)
         (coe v6))
      (coe du_comm_320 (coe v0) (coe v1) (coe v2) (coe v3) (coe v7))
...
d_isSelectiveMagma_390 ::
  ...
  MAlonzo.Code.Relation.Binary.Structures.T_IsEquivalence_26 ->
  MAlonzo.Code.Algebra.Structures.T_IsSelectiveMagma_158
d_isSelectiveMagma_390 ~v0 ~v1 ~v2 ~v3 v4 v5 ~v6 ~v7 ~v8 v9 v10 v11
                       v12
  = du_isSelectiveMagma_390 v4 v5 v9 v10 v11 v12
du_isSelectiveMagma_390 ::
  ...
  MAlonzo.Code.Relation.Binary.Structures.T_IsEquivalence_26 ->
  MAlonzo.Code.Algebra.Structures.T_IsSelectiveMagma_158
du_isSelectiveMagma_390 v0 v1 v2 v3 v4 v5
  = coe
...
d__'9702'__404 ::
  ...
  (AgdaAny -> ()) ->
  (AgdaAny -> AgdaAny) -> AgdaAny -> AgdaAny -> AgdaAny
d__'9702'__404 ~v0 ~v1 ~v2 ~v3 ~v4 v5 ~v6 ~v7 ~v8 ~v9 v10
  = du__'9702'__404 v5 v10
du__'9702'__404 ::
  MAlonzo.Code.Algebra.Structures.T_IsSelectiveMagma_158 ->
  (AgdaAny -> AgdaAny) -> AgdaAny -> AgdaAny -> AgdaAny
du__'9702'__404 v0 v1
  = coe
      du_Lift_30 (coe MAlonzo.Code.Algebra.Structures.d_sel_168 (coe v0))
      (coe v1)
...
d_preserves'7506'_418 ~v0 ~v1 ~v2 ~v3 ~v4 v5 ~v6 ~v7 ~v8 ~v9 v10
                      v11 v12 v13 v14 v15
  = du_preserves'7506'_418 v5 v10 v11 v12 v13 v14 v15
du_preserves'7506'_418 ::
  ...
  AgdaAny ->
  AgdaAny -> MAlonzo.Code.Data.Sum.Base.T__'8846'__30 -> AgdaAny
du_preserves'7506'_418 v0 v1 v2 v3 v4 v5 v6
  = case coe v6 of
      MAlonzo.Code.Data.Sum.Base.C_inj'8321'_38 v7
        -> let v8
                 = coe
                     MAlonzo.Code.Algebra.Structures.d_sel_168 v0 (coe v1 v4)
                     (coe v1 v5) in
           case coe v8 of
...
d_preserves'691'_500 ::
  ...
  (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny) ->
  AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
d_preserves'691'_500 ~v0 ~v1 ~v2 ~v3 ~v4 v5 ~v6 ~v7 ~v8 ~v9 v10 v11
                     v12 v13 v14
  = du_preserves'691'_500 v5 v10 v11 v12 v13 v14
du_preserves'691'_500 ::
  MAlonzo.Code.Algebra.Structures.T_IsSelectiveMagma_158 ->
  (AgdaAny -> AgdaAny) ->
  (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny) ->
  AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
du_preserves'691'_500 v0 v1 v2 v3 v4 v5
  = let v6
          = coe
              MAlonzo.Code.Algebra.Structures.d_sel_168 v0 (coe v1 v3)
              (coe v1 v4) in
    case coe v6 of
...
d_preserves'7495'_538 ::
  ...
  (AgdaAny -> AgdaAny) ->
  AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
d_preserves'7495'_538 ~v0 ~v1 ~v2 ~v3 ~v4 v5 ~v6 ~v7 ~v8 ~v9 v10
                      v11 v12 v13 v14
  = du_preserves'7495'_538 v5 v10 v11 v12 v13 v14
du_preserves'7495'_538 ::
  MAlonzo.Code.Algebra.Structures.T_IsSelectiveMagma_158 ->
  (AgdaAny -> AgdaAny) ->
  AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
du_preserves'7495'_538 v0 v1 v2 v3 v4 v5
  = let v6
          = coe
              MAlonzo.Code.Algebra.Structures.d_sel_168 v0 (coe v1 v2)
              (coe v1 v3) in
...
d_forces'7495'_580 ~v0 ~v1 ~v2 ~v3 ~v4 v5 ~v6 ~v7 ~v8 ~v9 v10 v11
                   v12 v13 v14 v15
  = du_forces'7495'_580 v5 v10 v11 v12 v13 v14 v15
du_forces'7495'_580 ::
  MAlonzo.Code.Algebra.Structures.T_IsSelectiveMagma_158 ->
  (AgdaAny -> AgdaAny) ->
  (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny) ->
  ...
  AgdaAny ->
  AgdaAny -> AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
du_forces'7495'_580 v0 v1 v2 v3 v4 v5 v6
  = let v7
          = coe
              MAlonzo.Code.Algebra.Structures.d_sel_168 v0 (coe v1 v4)
              (coe v1 v5) in
