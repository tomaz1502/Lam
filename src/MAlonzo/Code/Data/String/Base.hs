...
d_fromList'8314'_18
  = coe
      MAlonzo.Code.Function.Base.du__'8728''8242'__226
      (coe MAlonzo.Code.Agda.Builtin.String.d_primStringFromList_14)
      (coe MAlonzo.Code.Data.List.NonEmpty.Base.du_toList_62)
-- Data.String.Base._++_
d__'43''43'__20 ::
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
...
d_replicate_24 v0 v1
  = coe
      ...
      (coe
         MAlonzo.Code.Data.List.Base.du_replicate_306 (coe v0) (coe v1))
...
d_concat_28
  = coe
      MAlonzo.Code.Data.List.Base.du_foldr_240 (coe d__'43''43'__20)
      (coe ("" :: Data.Text.Text))
...
d_intersperse_30 v0
  = coe
      MAlonzo.Code.Function.Base.du__'8728''8242'__226 (coe d_concat_28)
      (coe MAlonzo.Code.Data.List.Base.du_intersperse_70 (coe v0))
  ...
  = let v4
    ...
    let v5
          = coe
              d__'43''43'__20
              (d_replicate_24
                 (coe MAlonzo.Code.Data.Nat.Base.d_'8970'_'47'2'8971'_126 (coe v4))
                 (coe v0))
              (coe
                 d__'43''43'__20 v3
                 (d_replicate_24
                    (coe MAlonzo.Code.Data.Nat.Base.d_'8968'_'47'2'8969'_130 (coe v4))
                    (coe v1))) in
    case coe v4 of
      0 -> coe v3
      _ -> coe v5
