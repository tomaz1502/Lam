...
du_argmin_118 v0 v1
  = coe
      ...
      (coe MAlonzo.Code.Data.List.Extrema.Core.du_'8851''7480'_338 v0 v1)
...
du_argmax_122 v0 v1
  = coe
      MAlonzo.Code.Data.List.Base.du_foldr_240
      (coe MAlonzo.Code.Data.List.Extrema.Core.du_'8852''7480'_340 v0 v1)
  ...
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               MAlonzo.Code.Data.List.Membership.Propositional.du_lose_54 v2 v4 v5
               (let v8
                      = MAlonzo.Code.Relation.Binary.Bundles.d_isTotalOrder_674
                          (coe v0) in
                let v9
...
du_min'45'mono'45''8838'_646 v0 v1 v2 v3 v4 v5 v6
  = coe
      ...
      (coe
         MAlonzo.Code.Data.List.Relation.Unary.All.du_tabulate_274 v4
         (\ v7 v8 ->
            coe
              MAlonzo.Code.Data.Sum.Base.C_inj'8322'_42
              (coe
...
du_max'45'mono'45''8838'_758 v0 v1 v2 v3 v4 v5 v6
  = coe
      ...
      (coe MAlonzo.Code.Data.Sum.Base.C_inj'8321'_38 (coe v5))
      (coe
         MAlonzo.Code.Data.List.Relation.Unary.All.du_tabulate_274 v3
         (\ v7 v8 ->
            coe
              MAlonzo.Code.Data.Sum.Base.C_inj'8322'_42
              (coe
