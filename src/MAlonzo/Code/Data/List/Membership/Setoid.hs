...
-- Data.List.Membership.Setoid.map-with-∈
d_map'45'with'45''8712'_98 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Relation.Binary.Bundles.T_Setoid_44 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  ...
  (AgdaAny ->
   MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34 -> AgdaAny) ->
  [AgdaAny]
d_map'45'with'45''8712'_98 ~v0 ~v1 v2
  = du_map'45'with'45''8712'_98 v2
du_map'45'with'45''8712'_98 ::
  MAlonzo.Code.Relation.Binary.Bundles.T_Setoid_44 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
  [AgdaAny] ->
  (AgdaAny ->
   MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34 -> AgdaAny) ->
  [AgdaAny]
du_map'45'with'45''8712'_98 v0 v1 v2 v3 v4
  = coe du_mapWith'8712'_58 (coe v0) v3 v4
