...
du_id_62
  = coe
      C_Π'46'constructor_769 (coe (\ v0 -> v0)) (coe (\ v0 v1 v2 -> v2))
-- Function.Equality._∘_
d__'8728'__82 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
...
du_const_100 v0 v1
  = coe
      C_Π'46'constructor_769 (coe (\ v2 -> v1))
      (coe
         (\ v2 v3 ->
            let v4
                  = coe
