...
data T_Equivalence_16
  = C_Equivalence'46'constructor_269 MAlonzo.Code.Function.Equality.T_Π_16
...
d_to_34 v0
  = case coe v0 of
      C_Equivalence'46'constructor_269 v1 v2 -> coe v1
...
d_from_36 v0
  = case coe v0 of
      C_Equivalence'46'constructor_269 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_equivalence_56 v0 v1
  = coe
      C_Equivalence'46'constructor_269
      (coe
...
du_sym_100 v0
  = coe
      C_Equivalence'46'constructor_269 (coe d_from_36 (coe v0))
      (coe d_to_34 (coe v0))
...
du_map_154 v0 v1 v2
  = coe
      C_Equivalence'46'constructor_269 (coe v0 (d_to_34 (coe v2)))
