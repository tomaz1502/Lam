...
data T_IsCongruent_22
  = C_IsCongruent'46'constructor_597 (AgdaAny ->
...
d_cong_32 v0
  = case coe v0 of
      C_IsCongruent'46'constructor_597 v1 v2 v3 -> coe v1
...
d_isEquivalence'8321'_34 v0
  = case coe v0 of
      C_IsCongruent'46'constructor_597 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Structures.IsCongruent.isEquivalence₂
...
d_isEquivalence'8322'_36 v0
  = case coe v0 of
      C_IsCongruent'46'constructor_597 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_injective_102 v0
  = case coe v0 of
      C_IsInjection'46'constructor_3223 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsSurjection_162
  = C_IsSurjection'46'constructor_5565 T_IsCongruent_22
...
d_isCongruent_170 v0
  = case coe v0 of
      C_IsSurjection'46'constructor_5565 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_surjective_172 v0
  = case coe v0 of
      C_IsSurjection'46'constructor_5565 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_surjective_242 v0
  = case coe v0 of
      C_IsBijection'46'constructor_7903 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsRightInverse_390
  = C_IsRightInverse'46'constructor_14463 T_IsCongruent_22
                                          (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
                                          (AgdaAny -> AgdaAny)
...
d_isCongruent_402 v0
  = case coe v0 of
      C_IsRightInverse'46'constructor_14463 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Structures.IsRightInverse.cong₂
d_cong'8322'_404 ::
  T_IsRightInverse_390 -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
d_cong'8322'_404 v0
  = case coe v0 of
      C_IsRightInverse'46'constructor_14463 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Structures.IsRightInverse.inverseʳ
d_inverse'691'_406 :: T_IsRightInverse_390 -> AgdaAny -> AgdaAny
d_inverse'691'_406 v0
  = case coe v0 of
      C_IsRightInverse'46'constructor_14463 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_isRightInverse_544 v0
  = coe
      C_IsRightInverse'46'constructor_14463
      (coe d_isCongruent_324 (coe d_isLeftInverse_478 (coe v0)))
      (coe d_cong'8322'_326 (coe d_isLeftInverse_478 (coe v0)))
...
data T_IsBiEquivalence_554
  = C_IsBiEquivalence'46'constructor_21071 T_IsCongruent_22
                                           (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
                                           (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
-- Function.Structures.IsBiEquivalence.f-isCongruent
d_f'45'isCongruent_568 :: T_IsBiEquivalence_554 -> T_IsCongruent_22
d_f'45'isCongruent_568 v0
  = case coe v0 of
      C_IsBiEquivalence'46'constructor_21071 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Structures.IsBiEquivalence.cong₂
d_cong'8322'_570 ::
  T_IsBiEquivalence_554 -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
d_cong'8322'_570 v0
  = case coe v0 of
      C_IsBiEquivalence'46'constructor_21071 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Structures.IsBiEquivalence.cong₃
d_cong'8323'_572 ::
  T_IsBiEquivalence_554 -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
d_cong'8323'_572 v0
  = case coe v0 of
      C_IsBiEquivalence'46'constructor_21071 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Structures.IsBiEquivalence._.cong
d_cong_576 ::
  T_IsBiEquivalence_554 -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
d_cong_576 v0 = coe d_cong_32 (coe d_f'45'isCongruent_568 (coe v0))
-- Function.Structures.IsBiEquivalence._.isEquivalence₁
d_isEquivalence'8321'_578 ::
  T_IsBiEquivalence_554 ->
  MAlonzo.Code.Relation.Binary.Structures.T_IsEquivalence_26
d_isEquivalence'8321'_578 v0
  = coe
      d_isEquivalence'8321'_34 (coe d_f'45'isCongruent_568 (coe v0))
-- Function.Structures.IsBiEquivalence._.isEquivalence₂
d_isEquivalence'8322'_580 ::
  T_IsBiEquivalence_554 ->
  MAlonzo.Code.Relation.Binary.Structures.T_IsEquivalence_26
d_isEquivalence'8322'_580 v0
  = coe
      d_isEquivalence'8322'_36 (coe d_f'45'isCongruent_568 (coe v0))
...
du_isEquivalence_590 v0
  = let v1 = d_f'45'isCongruent_568 (coe v0) in
    coe d_isEquivalence'8321'_34 (coe v1)
...
du_setoid_600 ::
  ...
  MAlonzo.Code.Relation.Binary.Bundles.T_Setoid_44
du_setoid_600 v0
  = coe du_setoid_40 (coe d_f'45'isCongruent_568 (coe v0))
...
du_setoid_624 ::
  ...
  MAlonzo.Code.Relation.Binary.Bundles.T_Setoid_44
du_setoid_624 v0
  = coe du_setoid_66 (coe d_f'45'isCongruent_568 (coe v0))
-- Function.Structures.IsBiEquivalence._.Eq₂.sym
d_sym_626 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
...
data T_IsBiInverse_636
  = C_IsBiInverse'46'constructor_25141 T_IsCongruent_22
                                       (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
                                       (AgdaAny -> AgdaAny)
                                       (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
                                       (AgdaAny -> AgdaAny)
-- Function.Structures.IsBiInverse.f-isCongruent
d_f'45'isCongruent_654 :: T_IsBiInverse_636 -> T_IsCongruent_22
d_f'45'isCongruent_654 v0
  = case coe v0 of
      C_IsBiInverse'46'constructor_25141 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Structures.IsBiInverse.cong₂
d_cong'8322'_656 ::
  T_IsBiInverse_636 -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
d_cong'8322'_656 v0
  = case coe v0 of
      C_IsBiInverse'46'constructor_25141 v1 v2 v3 v4 v5 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Structures.IsBiInverse.inverseˡ
d_inverse'737'_658 :: T_IsBiInverse_636 -> AgdaAny -> AgdaAny
d_inverse'737'_658 v0
  = case coe v0 of
      C_IsBiInverse'46'constructor_25141 v1 v2 v3 v4 v5 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Structures.IsBiInverse.cong₃
d_cong'8323'_660 ::
  T_IsBiInverse_636 -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
d_cong'8323'_660 v0
  = case coe v0 of
      C_IsBiInverse'46'constructor_25141 v1 v2 v3 v4 v5 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Structures.IsBiInverse.inverseʳ
d_inverse'691'_662 :: T_IsBiInverse_636 -> AgdaAny -> AgdaAny
d_inverse'691'_662 v0
  = case coe v0 of
      C_IsBiInverse'46'constructor_25141 v1 v2 v3 v4 v5 -> coe v5
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Structures.IsBiInverse._.cong
d_cong_666 ::
  T_IsBiInverse_636 -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
d_cong_666 v0 = coe d_cong_32 (coe d_f'45'isCongruent_654 (coe v0))
-- Function.Structures.IsBiInverse._.isEquivalence₁
d_isEquivalence'8321'_668 ::
  T_IsBiInverse_636 ->
  MAlonzo.Code.Relation.Binary.Structures.T_IsEquivalence_26
d_isEquivalence'8321'_668 v0
  = coe
      d_isEquivalence'8321'_34 (coe d_f'45'isCongruent_654 (coe v0))
-- Function.Structures.IsBiInverse._.isEquivalence₂
d_isEquivalence'8322'_670 ::
  T_IsBiInverse_636 ->
  MAlonzo.Code.Relation.Binary.Structures.T_IsEquivalence_26
d_isEquivalence'8322'_670 v0
  = coe
      d_isEquivalence'8322'_36 (coe d_f'45'isCongruent_654 (coe v0))
...
du_isEquivalence_680 v0
  = let v1 = d_f'45'isCongruent_654 (coe v0) in
    coe d_isEquivalence'8321'_34 (coe v1)
...
du_setoid_690 ::
  ...
  MAlonzo.Code.Relation.Binary.Bundles.T_Setoid_44
du_setoid_690 v0
  = coe du_setoid_40 (coe d_f'45'isCongruent_654 (coe v0))
...
du_setoid_714 ::
  ...
  MAlonzo.Code.Relation.Binary.Bundles.T_Setoid_44
du_setoid_714 v0
  = coe du_setoid_66 (coe d_f'45'isCongruent_654 (coe v0))
-- Function.Structures.IsBiInverse._.Eq₂.sym
d_sym_716 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
