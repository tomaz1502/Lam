...
data T__InverseOf__20
  = C__InverseOf_'46'constructor_1525 (AgdaAny -> AgdaAny)
                                      (AgdaAny -> AgdaAny)
...
d_left'45'inverse'45'of_42 v0
  = case coe v0 of
      C__InverseOf_'46'constructor_1525 v1 v2 -> coe v1
...
d_right'45'inverse'45'of_44 v0
  = case coe v0 of
      C__InverseOf_'46'constructor_1525 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Inverse.Inverse
d_Inverse_58 a0 a1 a2 a3 a4 a5 = ()
data T_Inverse_58
  = C_Inverse'46'constructor_2615 MAlonzo.Code.Function.Equality.T_Π_16
...
du_bijection_98 v0 v1
  = coe
      MAlonzo.Code.Function.Bijection.C_Bijection'46'constructor_3549
      (coe d_to_78 (coe v1))
      (coe
         MAlonzo.Code.Function.Bijection.C_Bijective'46'constructor_1235
         (coe
            MAlonzo.Code.Function.LeftInverse.du_injective_176 (coe v0)
            (coe du_left'45'inverse_90 (coe v1)))
         (coe
      ...
      (coe
         ...
         (coe
            ...
            (coe
               ...
               erased erased erased))
         v1)
      (coe C__InverseOf_'46'constructor_1525 (coe v2) (coe v3))
...
du_fromBijection_178 v0
  = coe
      ...
      (coe
         C__InverseOf_'46'constructor_1525
         (coe
...
du_sym_226 v0
  = coe
      C_Inverse'46'constructor_2615 (coe d_from_80 (coe v0))
      (coe d_to_78 (coe v0))
      (coe
         C__InverseOf_'46'constructor_1525
         (coe d_right'45'inverse'45'of_44 (coe d_inverse'45'of_82 (coe v0)))
...
du_map_298 v0 v1 v2 v3
  = coe
      C_Inverse'46'constructor_2615 (coe v0 (d_to_78 (coe v3)))
