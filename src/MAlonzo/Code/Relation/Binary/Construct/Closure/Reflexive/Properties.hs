...
du_'8846''8660'Refl_84
  = coe
      ...
      (coe du_fromSum_68) (coe du_toSum_76)
...
du_resp'8322'_270
  = coe
      MAlonzo.Code.Data.Product.du_map_148 (coe du_resp'737'_226)
...
d_isDecPartialOrder_328 ~v0 ~v1 ~v2 ~v3 v4
  = du_isDecPartialOrder_328 v4
du_isDecPartialOrder_328 ::
  MAlonzo.Code.Relation.Binary.Structures.T_IsDecStrictPartialOrder_314 ->
  MAlonzo.Code.Relation.Binary.Structures.T_IsDecPartialOrder_206
du_isDecPartialOrder_328 v0
  = coe
      ...
      (coe
         ...
         (coe
            ...
            (coe v0)))
      (coe
         MAlonzo.Code.Relation.Binary.Structures.d__'8799'__326 (coe v0))
      (coe
         du_dec_174
         (coe
            MAlonzo.Code.Relation.Binary.Structures.d__'8799'__326 (coe v0))
         (coe
            MAlonzo.Code.Relation.Binary.Structures.d__'60''63'__328 (coe v0)))
...
d_isTotalOrder_378 ~v0 ~v1 ~v2 ~v3 v4 = du_isTotalOrder_378 v4
du_isTotalOrder_378 ::
  MAlonzo.Code.Relation.Binary.Structures.T_IsStrictTotalOrder_502 ->
  MAlonzo.Code.Relation.Binary.Structures.T_IsTotalOrder_384
...
d_isDecTotalOrder_430 ~v0 ~v1 ~v2 ~v3 v4
  = du_isDecTotalOrder_430 v4
du_isDecTotalOrder_430 ::
  MAlonzo.Code.Relation.Binary.Structures.T_IsStrictTotalOrder_502 ->
  MAlonzo.Code.Relation.Binary.Structures.T_IsDecTotalOrder_434
du_isDecTotalOrder_430 v0
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C_IsDecTotalOrder'46'constructor_17071
      (coe du_isTotalOrder_378 (coe v0))
      (coe
