...
data T_ProtoMetric_16
  = C_ProtoMetric'46'constructor_607 AgdaAny
...
d_0'35'_54 v0
  = case coe v0 of
      C_ProtoMetric'46'constructor_607 v6 v7 v8 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Metric.Bundles.ProtoMetric.d
d_d_56 :: T_ProtoMetric_16 -> AgdaAny -> AgdaAny -> AgdaAny
d_d_56 v0
  = case coe v0 of
      C_ProtoMetric'46'constructor_607 v6 v7 v8 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isProtoMetric_58 v0
  = case coe v0 of
      C_ProtoMetric'46'constructor_607 v6 v7 v8 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_PreMetric_122
  = C_PreMetric'46'constructor_3305 AgdaAny
                                    (AgdaAny -> AgdaAny -> AgdaAny)
...
d_0'35'_160 v0
  = case coe v0 of
      C_PreMetric'46'constructor_3305 v6 v7 v8 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Metric.Bundles.PreMetric.d
d_d_162 :: T_PreMetric_122 -> AgdaAny -> AgdaAny -> AgdaAny
d_d_162 v0
  = case coe v0 of
      C_PreMetric'46'constructor_3305 v6 v7 v8 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isPreMetric_164 v0
  = case coe v0 of
      C_PreMetric'46'constructor_3305 v6 v7 v8 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_protoMetric_222 v0
  = coe
      C_ProtoMetric'46'constructor_607 (d_0'35'_160 (coe v0))
      (d_d_162 (coe v0))
      (MAlonzo.Code.Function.Metric.Structures.d_isProtoMetric_104
         (coe d_isPreMetric_164 (coe v0)))
...
data T_QuasiSemiMetric_234
  = C_QuasiSemiMetric'46'constructor_6501 AgdaAny
                                          (AgdaAny -> AgdaAny -> AgdaAny)
...
d_0'35'_272 v0
  = case coe v0 of
      C_QuasiSemiMetric'46'constructor_6501 v6 v7 v8 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Metric.Bundles.QuasiSemiMetric.d
d_d_274 :: T_QuasiSemiMetric_234 -> AgdaAny -> AgdaAny -> AgdaAny
d_d_274 v0
  = case coe v0 of
      C_QuasiSemiMetric'46'constructor_6501 v6 v7 v8 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isQuasiSemiMetric_276 v0
  = case coe v0 of
      C_QuasiSemiMetric'46'constructor_6501 v6 v7 v8 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_preMetric_338 v0
  = coe
      C_PreMetric'46'constructor_3305 (d_0'35'_272 (coe v0))
      (d_d_274 (coe v0))
      (MAlonzo.Code.Function.Metric.Structures.d_isPreMetric_170
         (coe d_isQuasiSemiMetric_276 (coe v0)))
...
data T_SemiMetric_354
  = C_SemiMetric'46'constructor_9957 AgdaAny
                                     (AgdaAny -> AgdaAny -> AgdaAny)
...
d_0'35'_392 v0
  = case coe v0 of
      C_SemiMetric'46'constructor_9957 v6 v7 v8 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Metric.Bundles.SemiMetric.d
d_d_394 :: T_SemiMetric_354 -> AgdaAny -> AgdaAny -> AgdaAny
d_d_394 v0
  = case coe v0 of
      C_SemiMetric'46'constructor_9957 v6 v7 v8 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isSemiMetric_396 v0
  = case coe v0 of
      C_SemiMetric'46'constructor_9957 v6 v7 v8 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_quasiSemiMetric_462 v0
  = coe
      C_QuasiSemiMetric'46'constructor_6501 (d_0'35'_392 (coe v0))
      (d_d_394 (coe v0))
      (MAlonzo.Code.Function.Metric.Structures.d_isQuasiSemiMetric_240
         (coe d_isSemiMetric_396 (coe v0)))
...
data T_GeneralMetric_480
  = C_GeneralMetric'46'constructor_13645 AgdaAny
                                         (AgdaAny -> AgdaAny -> AgdaAny)
                                         (AgdaAny -> AgdaAny -> AgdaAny)
...
d_0'35'_520 v0
  = case coe v0 of
      C_GeneralMetric'46'constructor_13645 v6 v7 v8 v9 -> coe v6
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Metric.Bundles.GeneralMetric._∙_
d__'8729'__522 ::
...
d__'8729'__522 v0
  = case coe v0 of
      C_GeneralMetric'46'constructor_13645 v6 v7 v8 v9 -> coe v7
      _ -> MAlonzo.RTE.mazUnreachableError
-- Function.Metric.Bundles.GeneralMetric.d
d_d_524 :: T_GeneralMetric_480 -> AgdaAny -> AgdaAny -> AgdaAny
d_d_524 v0
  = case coe v0 of
      C_GeneralMetric'46'constructor_13645 v6 v7 v8 v9 -> coe v8
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isGeneralMetric_526 v0
  = case coe v0 of
      C_GeneralMetric'46'constructor_13645 v6 v7 v8 v9 -> coe v9
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_semiMetric_596 v0
  = coe
      C_SemiMetric'46'constructor_9957 (d_0'35'_520 (coe v0))
      (d_d_524 (coe v0))
      (MAlonzo.Code.Function.Metric.Structures.d_isSemiMetric_318
         (coe d_isGeneralMetric_526 (coe v0)))
