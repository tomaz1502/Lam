...
newtype T_IsRelHomomorphism_42
  = C_IsRelHomomorphism'46'constructor_371 (AgdaAny ->
...
d_cong_52 v0
  = case coe v0 of
      C_IsRelHomomorphism'46'constructor_371 v1 -> coe v1
...
data T_IsRelMonomorphism_64
  = C_IsRelMonomorphism'46'constructor_1081 T_IsRelHomomorphism_42
                                            (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
d_isHomomorphism_76 v0
  = case coe v0 of
      C_IsRelMonomorphism'46'constructor_1081 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_injective_78 v0
  = case coe v0 of
      C_IsRelMonomorphism'46'constructor_1081 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsRelIsomorphism_94
  = C_IsRelIsomorphism'46'constructor_2251 T_IsRelMonomorphism_64
...
d_isMonomorphism_106 v0
  = case coe v0 of
      C_IsRelIsomorphism'46'constructor_2251 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_surjective_108 v0
  = case coe v0 of
      C_IsRelIsomorphism'46'constructor_2251 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsOrderHomomorphism_138
  = C_IsOrderHomomorphism'46'constructor_4085 (AgdaAny ->
                                               AgdaAny -> AgdaAny -> AgdaAny)
                                              (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
d_cong_154 v0
  = case coe v0 of
      C_IsOrderHomomorphism'46'constructor_4085 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_mono_156 v0
  = case coe v0 of
      C_IsOrderHomomorphism'46'constructor_4085 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_isRelHomomorphism_160 v0
  = coe
      C_IsRelHomomorphism'46'constructor_371 (coe d_cong_154 (coe v0))
...
du_isRelHomomorphism_162 v0
  = coe
      C_IsRelHomomorphism'46'constructor_371 (coe d_mono_156 (coe v0))
...
data T_IsOrderMonomorphism_182
  = C_IsOrderMonomorphism'46'constructor_6791 T_IsOrderHomomorphism_138
                                              (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
                                              (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
d_isOrderHomomorphism_200 v0
  = case coe v0 of
      C_IsOrderMonomorphism'46'constructor_6791 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_injective_202 v0
  = case coe v0 of
      C_IsOrderMonomorphism'46'constructor_6791 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_cancel_204 v0
  = case coe v0 of
      C_IsOrderMonomorphism'46'constructor_6791 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_isRelMonomorphism_216 v0
  = coe
      C_IsRelMonomorphism'46'constructor_1081
      (coe
...
data T_IsOrderIsomorphism_238
  = C_IsOrderIsomorphism'46'constructor_10737 T_IsOrderMonomorphism_182
                                              (AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14)
...
d_isOrderMonomorphism_254 v0
  = case coe v0 of
      C_IsOrderIsomorphism'46'constructor_10737 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_surjective_256 v0
  = case coe v0 of
      C_IsOrderIsomorphism'46'constructor_10737 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_isRelIsomorphism_276 v0
  = coe
      C_IsRelIsomorphism'46'constructor_2251
      (coe
