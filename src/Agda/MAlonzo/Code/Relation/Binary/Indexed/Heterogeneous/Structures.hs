...
data T_IsIndexedEquivalence_22
  = C_IsIndexedEquivalence'46'constructor_719 (AgdaAny ->
                                               AgdaAny -> AgdaAny)
                                              (AgdaAny ->
...
d_refl_30 v0
  = case coe v0 of
      C_IsIndexedEquivalence'46'constructor_719 v1 v2 v3 -> coe v1
...
d_sym_32 v0
  = case coe v0 of
      C_IsIndexedEquivalence'46'constructor_719 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_trans_34 v0
  = case coe v0 of
      C_IsIndexedEquivalence'46'constructor_719 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_IsIndexedPreorder_44
  = C_IsIndexedPreorder'46'constructor_3265 T_IsIndexedEquivalence_22
                                            (AgdaAny ->
                                             AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
                                            (AgdaAny ->
                                             AgdaAny ->
...
d_isEquivalence_60 v0
  = case coe v0 of
      C_IsIndexedPreorder'46'constructor_3265 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_reflexive_66 v0
  = case coe v0 of
      C_IsIndexedPreorder'46'constructor_3265 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_trans_68 v0
  = case coe v0 of
      C_IsIndexedPreorder'46'constructor_3265 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
