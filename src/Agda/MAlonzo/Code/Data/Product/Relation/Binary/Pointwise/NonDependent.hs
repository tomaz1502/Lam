...
d__'215''45'Rel__518 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 -> ()
d__'215''45'Rel__518 = erased
-- Data.Product.Relation.Binary.Pointwise.NonDependent.Rel↔≡
d_Rel'8596''8801'_520 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () -> () -> MAlonzo.Code.Function.Inverse.T_Inverse_58
d_Rel'8596''8801'_520 v0 v1 v2 v3
  = coe du_Pointwise'45''8801''8596''8801'_512
...
d__'215''45'reflexive__522 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d__'215''45'reflexive__522 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11
                           v12 v13 v14
  = coe du_'215''45'reflexive_42 v10 v11 v12 v13 v14
...
d__'215''45'refl__524 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d__'215''45'refl__524 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
  = coe du_'215''45'refl_56 v8 v9 v10
...
d__'215''45'symmetric__526 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d__'215''45'symmetric__526 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11
                           v12
  = coe du_'215''45'symmetric_98 v8 v9 v10 v11 v12
...
d__'215''45'transitive__528 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d__'215''45'transitive__528 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11
                            v12 v13 v14
  = coe du_'215''45'transitive_112 v8 v9 v10 v11 v12 v13 v14
...
d__'215''45'antisymmetric__530 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d__'215''45'antisymmetric__530 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
                               v11 v12 v13 v14 v15
  = coe du_'215''45'antisymmetric_130 v10 v11 v12 v13 v14 v15
...
d__'215''45''8776''45'respects'8322'__532 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d__'215''45''8776''45'respects'8322'__532 v0 v1 v2 v3 v4 v5 v6 v7
                                          v8 v9 v10 v11
  = coe du_'215''45'respects'8322'_176 v10 v11
...
d__'215''45'decidable__534 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Relation.Nullary.T_Dec_32
d__'215''45'decidable__534 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11
  = coe du_'215''45'decidable_318 v8 v9 v10 v11
...
d__'215''45'isEquivalence__536 ::
  ...
  MAlonzo.Code.Relation.Binary.Structures.T_IsEquivalence_26 ->
  MAlonzo.Code.Relation.Binary.Structures.T_IsEquivalence_26
d__'215''45'isEquivalence__536 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9
  = coe du_'215''45'isEquivalence_336 v8 v9
...
d__'215''45'isDecEquivalence__538 ::
  ...
  MAlonzo.Code.Relation.Binary.Structures.T_IsDecEquivalence_44 ->
  MAlonzo.Code.Relation.Binary.Structures.T_IsDecEquivalence_44
d__'215''45'isDecEquivalence__538 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9
  = coe du_'215''45'isDecEquivalence_354 v8 v9
...
d__'215''45'isPreorder__540 ::
  ...
  MAlonzo.Code.Relation.Binary.Structures.T_IsPreorder_70 ->
  MAlonzo.Code.Relation.Binary.Structures.T_IsPreorder_70
d__'215''45'isPreorder__540 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11
  = coe du_'215''45'isPreorder_372 v10 v11
...
d__'215''45'isPartialOrder__542 ::
  ...
  MAlonzo.Code.Relation.Binary.Structures.T_IsPartialOrder_162 ->
  MAlonzo.Code.Relation.Binary.Structures.T_IsPartialOrder_162
d__'215''45'isPartialOrder__542 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10
                                v11
  = coe du_'215''45'isPartialOrder_394 v10 v11
...
d__'215''45'isStrictPartialOrder__544 ::
  ...
  MAlonzo.Code.Relation.Binary.Structures.T_IsStrictPartialOrder_266 ->
  MAlonzo.Code.Relation.Binary.Structures.T_IsStrictPartialOrder_266
d__'215''45'isStrictPartialOrder__544 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9
                                      v10 v11
  = coe du_'215''45'isStrictPartialOrder_416 v10 v11
...
d__'215''45'preorder__546 ::
  ...
  MAlonzo.Code.Relation.Binary.Bundles.T_Preorder_132 ->
  MAlonzo.Code.Relation.Binary.Bundles.T_Preorder_132
d__'215''45'preorder__546 v0 v1 v2 v3 v4 v5
  = coe du_'215''45'preorder_444 v4 v5
...
d__'215''45'setoid__548 ::
  ...
  MAlonzo.Code.Relation.Binary.Bundles.T_Setoid_44 ->
  MAlonzo.Code.Relation.Binary.Bundles.T_Setoid_44
d__'215''45'setoid__548 v0 v1 v2 v3 v4 v5
  = coe du_'215''45'setoid_454 v4 v5
...
d__'215''45'decSetoid__550 ::
  ...
  MAlonzo.Code.Relation.Binary.Bundles.T_DecSetoid_84 ->
  MAlonzo.Code.Relation.Binary.Bundles.T_DecSetoid_84
d__'215''45'decSetoid__550 v0 v1 v2 v3 v4 v5
  = coe du_'215''45'decSetoid_464 v4 v5
...
d__'215''45'poset__552 ::
  ...
  MAlonzo.Code.Relation.Binary.Bundles.T_Poset_282 ->
  MAlonzo.Code.Relation.Binary.Bundles.T_Poset_282
d__'215''45'poset__552 v0 v1 v2 v3 v4 v5
  = coe du_'215''45'poset_474 v4 v5
...
d__'215''45'strictPartialOrder__554 ::
  ...
  MAlonzo.Code.Relation.Binary.Bundles.T_StrictPartialOrder_472 ->
  MAlonzo.Code.Relation.Binary.Bundles.T_StrictPartialOrder_472
d__'215''45'strictPartialOrder__554 v0 v1 v2 v3 v4 v5
  = coe du_'215''45'strictPartialOrder_484 v4 v5
...
d__'215''45''8799'__556 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Relation.Nullary.T_Dec_32
d__'215''45''8799'__556 v0 v1 v2 v3 v4 v5 v6 v7
  = coe
      MAlonzo.Code.Data.Product.Properties.du_'8801''45'dec_70 v4 v5 v6
      v7
...
d_'8801''63''215''8801''63''8658''8801''63'_558 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Relation.Nullary.T_Dec_32
d_'8801''63''215''8801''63''8658''8801''63'_558 v0 v1 v2 v3 v4 v5
                                                v6 v7
  = coe
      MAlonzo.Code.Data.Product.Properties.du_'8801''45'dec_70 v4 v5 v6
      v7
