...
d_map'45'with'45''8712'_20 ::
  ...
  [AgdaAny]
d_map'45'with'45''8712'_20 ~v0 ~v1 = du_map'45'with'45''8712'_20
...
du_mapWith'8712'_22 ::
  ...
  (AgdaAny ->
   MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34 -> AgdaAny) ->
  [AgdaAny]
du_mapWith'8712'_22 v0 v1 v2 v3
  = coe
...
d__'8759''61'__26 ::
  ...
  MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34 ->
  AgdaAny -> [AgdaAny]
d__'8759''61'__26 ~v0 ~v1 = du__'8759''61'__26
du__'8759''61'__26 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  ...
  MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34 ->
  AgdaAny -> [AgdaAny]
du__'8759''61'__26 v0 v1 v2 v3 v4 v5 v6
  = coe
...
d__'9472'__28 ::
  ...
  [AgdaAny] ->
  MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34 -> [AgdaAny]
d__'9472'__28 ~v0 ~v1 = du__'9472'__28
du__'9472'__28 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  ...
  [AgdaAny] ->
  MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34 -> [AgdaAny]
du__'9472'__28 v0 v1 v2 v3 v4 v5
  = coe
...
d_lose_54 ~v0 ~v1 ~v2 ~v3 v4 v5 = du_lose_54 v4 v5
du_lose_54 ::
  AgdaAny ->
  [AgdaAny] ->
  MAlonzo.Code.Data.List.Relation.Unary.Any.T_Any_34 ->
