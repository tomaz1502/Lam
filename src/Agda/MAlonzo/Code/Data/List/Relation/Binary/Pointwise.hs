         ...
         (coe
            (\ v0 ->
               coe
                 ...
                 erased (coe v0)))
         erased)
-- Data.List.Relation.Binary.Pointwise.Rel
d_Rel_586 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
...
d_Rel'8801''8658''8801'_588 ::
  ...
  MAlonzo.Code.Data.List.Relation.Binary.Pointwise.Base.T_Pointwise_48 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_Rel'8801''8658''8801'_588 = erased
-- Data.List.Relation.Binary.Pointwise.≡⇒Rel≡
d_'8801''8658'Rel'8801'_590 ::
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  MAlonzo.Code.Data.List.Relation.Binary.Pointwise.Base.T_Pointwise_48
d_'8801''8658'Rel'8801'_590 v0 v1 v2 v3 v4
  = coe du_'8801''8658'Pointwise'45''8801'_578 v2
-- Data.List.Relation.Binary.Pointwise.Rel↔≡
d_Rel'8596''8801'_592 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () -> MAlonzo.Code.Function.Inverse.T_Inverse_58
d_Rel'8596''8801'_592 v0 v1
  = coe du_Pointwise'45''8801''8596''8801'_580
...
d_decidable'45''8801'_594 ::
  ...
  [AgdaAny] -> [AgdaAny] -> MAlonzo.Code.Relation.Nullary.T_Dec_32
d_decidable'45''8801'_594 v0 v1 v2 v3 v4
  = coe
