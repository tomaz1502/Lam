...
le V rewrite iterShiftUpSuc {V} {S Z} = varNotContainedImplies (shiftUp V) Z Z (s≤Self Z) (varNotContainedShiftUp V Z)
...
le2 (Lam x₂ x₃ V) (Lam x x₁ N) i (vn-lam h) = vn-lam (le2 (shiftUp (Lam x₂ x₃ V)) N (S i) (vn-lam (varNotContainedImplies V (S i) (S Z) (s≤s z≤) h)))
le2 (App V V₁) (Lam x x₁ N) i h = vn-lam (le2 (shiftUp (App V V₁)) N (S i) (varNotContainedImplies (App V V₁) i Z z≤ h))
le2 (Ite V V₁ V₂) (Lam x x₁ N) i h = vn-lam (le2 (shiftUp (Ite V V₁ V₂)) N (S i) (varNotContainedImplies (Ite V V₁ V₂) i Z z≤ h))
le2 (Inl V x₂) (Lam x x₁ N) i h = vn-lam (le2 (shiftUp (Inl V x₂)) N (S i) (varNotContainedImplies (Inl V x₂) i Z z≤ h))
le2 (Inr V x₂) (Lam x x₁ N) i h = vn-lam (le2 (shiftUp (Inr V x₂)) N (S i) (varNotContainedImplies (Inr V x₂) i Z z≤ h))
le2 (Case V x₂ V₁ x₃ V₂) (Lam x x₁ N) i (vn-case h1 h2 h3) = vn-lam (le2 (shiftUp (Case V x₂ V₁ x₃ V₂)) N (S i) (vn-case (varNotContainedImplies V i Z z≤ h1) (varNotContainedImplies V₁ (S i) (S Z) (s≤s z≤) h2) (varNotContainedImplies V₂ (S i) (S Z) (s≤s z≤) h3)))
le2 (Const x₂) (Lam x x₁ N) i vn-v = vn-lam (le2 (Const x₂) N (S i) vn-v)
le2 (BinOp x₂ V V₁) (Lam x x₁ N) i h = vn-lam (le2 (shiftUp (BinOp x₂ V V₁)) N (S i) (varNotContainedImplies (BinOp x₂ V V₁) i Z z≤ h))
le2 (UnaryOp x₂ V) (Lam x x₁ N) i (vn-unop h) = vn-lam (le2 (shiftUp (UnaryOp x₂ V)) N (S i) (varNotContainedImplies (UnaryOp x₂ V) i Z z≤ (vn-unop h)))
...
le2 (BinOp o e1 e2) (Case N x N₁ x₁ N₂) i h = vn-case (le2 (BinOp o e1 e2) N i h) (le2 (shiftUp (BinOp o e1 e2)) N₁ (S i) (varNotContainedImplies (BinOp o e1 e2) i Z z≤ h)) ((le2 (shiftUp (BinOp o e1 e2)) N₂ (S i) (varNotContainedImplies (BinOp o e1 e2) i Z z≤ h)))
le2 (UnaryOp o e) (Case N x N₁ x₁ N₂) i (vn-unop h) = vn-case (le2 (UnaryOp o e) N i (vn-unop h)) (le2 (shiftUp (UnaryOp o e)) N₁ (S i) (varNotContainedImplies (UnaryOp o e) i Z z≤ (vn-unop h))) ((le2 (shiftUp (UnaryOp o e)) N₂ (S i) (varNotContainedImplies (UnaryOp o e) i Z z≤ (vn-unop h))))
le2 (App e1 e2) (Case N x N₁ x₁ N₂) i h = vn-case (le2 (App e1 e2) N i h) (le2 (shiftUp (App e1 e2)) N₁ (S i) (varNotContainedImplies (App e1 e2) i Z z≤ h)) ((le2 (shiftUp (App e1 e2)) N₂ (S i) (varNotContainedImplies (App e1 e2) i Z z≤ h)))
le2 (Ite e1 e2 e3) (Case N x N₁ x₁ N₂) i h = vn-case (le2 (Ite e1 e2 e3) N i h) (le2 (shiftUp (Ite e1 e2 e3)) N₁ (S i) (varNotContainedImplies (Ite e1 e2 e3) i Z z≤ h)) ((le2 (shiftUp (Ite e1 e2 e3)) N₂ (S i) (varNotContainedImplies (Ite e1 e2 e3) i Z z≤ h)))
le2 (Inl e t) (Case N x N₁ x₁ N₂) i h = vn-case (le2 (Inl e t) N i h) (le2 (shiftUp (Inl e t)) N₁ (S i) (varNotContainedImplies (Inl e t) i Z z≤ h)) ((le2 (shiftUp (Inl e t)) N₂ (S i) (varNotContainedImplies (Inl e t) i Z z≤ h)))
le2 (Inr e t) (Case N x N₁ x₁ N₂) i h = vn-case (le2 (Inr e t) N i h) (le2 (shiftUp (Inr e t)) N₁ (S i) (varNotContainedImplies (Inr e t) i Z z≤ h)) ((le2 (shiftUp (Inr e t)) N₂ (S i) (varNotContainedImplies (Inr e t) i Z z≤ h)))
le2 (Lam n ty b) (Case N x N₁ x₁ N₂) i h = vn-case (le2 (Lam n ty b) N i h) (le2 (shiftUp (Lam n ty b)) N₁ (S i) (varNotContainedImplies (Lam n ty b) i Z z≤ h)) ((le2 (shiftUp (Lam n ty b)) N₂ (S i) (varNotContainedImplies (Lam n ty b) i Z z≤ h)))
le2 (Case E1 id2 E2 id3 E3) (Case N x N₁ x₁ N₂) i h = vn-case (le2 (Case E1 id2 E2 id3 E3) N i h) (le2 (shiftUp (Case E1 id2 E2 id3 E3)) N₁ (S i) (varNotContainedImplies (Case E1 id2 E2 id3 E3) i Z z≤ h)) ((le2 (shiftUp (Case E1 id2 E2 id3 E3)) N₂ (S i) (varNotContainedImplies (Case E1 id2 E2 id3 E3) i Z z≤ h)))
