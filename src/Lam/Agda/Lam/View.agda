...
open import Lam.FormalizationEvaluator using (Normal)
...
viewInl (Var x) = inj₂ λ ()
viewInl (Lam x x₁ L) = inj₂ λ ()
viewInl (App L L₁) = inj₂ λ ()
viewInl (Ite L L₁ L₂) = inj₂ λ ()
viewInl (Inl L M) = inj₁ ⟨ L , ⟨ M , refl ⟩ ⟩
viewInl (Inr L M) = inj₂ λ ()
viewInl (Case L x L₁ x₁ L₂) = inj₂ λ ()
